...
module.exports = {
  colors:colors,
  generateHTML:function(answers, res){
    return `<!DOCTYPE html>
    <html lang="en">
       <head>
          <meta charset="UTF-8" />
                ...
                <div class="wrapper">                                                
                  <div class = "photo-header">                                                        
                    <div class = "photo-header img">
                      <img src="${res.data.avatar_url}" alt="image"></img>                  
                      </div> 
                      <div class ="row">
                        <h1>Hi!</h1> 
                        ...
                        <h5>
                          <a href="https://www.google.com/maps/place/${res.data.location}">Location: ${res.data.location}</a>                 
